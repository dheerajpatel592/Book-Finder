        ...
        try {
            ...
            for(int i = 0 ; i< bookArray.length() ;i++) {
                ...
                try {
                    ...
                    bookName = bookName + " : " + subtitle;
                }catch (Exception e) {
                    Log.e(LOG_TAG, "Subtitle : No subtitle found");
                }
                Log.e(LOG_TAG, "book name = " + bookName);

                StringBuilder s = new StringBuilder();
                try {
                    JSONArray authors = bookInfo.getJSONArray("authors");
                    for (int j = 0; j < authors.length(); j++) {
                        String toAdd = authors.getString(j);
                        s.append(toAdd).append("     ");
                    }
                }catch (Exception e){
                    Log.e(LOG_TAG, "author = No authors found");
                }
                String authorName = s.toString();
                Log.e(LOG_TAG,"author name = " + authorName);
                ...
                Book book = new Book(bookName, authorName, imageUrl, url);
                books.add(book);
            }
